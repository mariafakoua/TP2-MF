...
public class TestOuvrage {
    ...
    public void testOuvrages() {
        ...
        Ouvrage livre2 = new OuvrageVideo("Tout va bien", albertine, Ouvrage.Format.AUDIO, 9, -10);
        System.out.println(livre2);

        livre2 = new OuvrageVideo("Tout va bien", albertine, Ouvrage.Format.PAPIER, 8, 20);
        System.out.println(livre2);
